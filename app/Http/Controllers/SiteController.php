...
class SiteController extends Controller
{
    ...
    public function about()
    {
        ...
        return view('pages.about', array_merge(SiteData::staticPageSummary(), [
            ...
            'values' => [
                ['title' => 'Проследим процес', 'desc' => 'Всяка заявка влиза в централен backend поток с история на комуникацията и статус на заявката.'],
                ['title' => 'Качествен сервиз', 'desc' => 'Работим с проверени части, диагностика и гаранция до 12 месеца според вида ремонт.'],
                ['title' => 'Покритие в цяла България', 'desc' => 'Онлайн заявка, куриер в двете посоки и готовност за връзка по телефон, имейл и чат канали.'],
            ],
            'seo' => [
