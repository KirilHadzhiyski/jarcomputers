...
class SiteController extends Controller
{
    ...
    public function contact()
    {
        ...
        return view('pages.contact', array_merge(SiteData::staticPageSummary(), [
            'seo' => [
                ...
                'description' => "Свържете се с {$site['brand']} за ремонт на iPhone. Телефон, имейл, Viber и онлайн заявка. Куриерска услуга в цяла България.",
            ],
        ]));
    }
    ...
    public function privacy()
    {
        ...
        return view('pages.legal', array_merge(SiteData::staticPageSummary(), [
            ...
            'pageIntro' => 'Тази политика описва как обработваме данните, които подавате чрез формата за ремонт, имейл и телефон.',
            'sections' => [
                [
                    ...
                    'body' => [
                        ...
                        'При имейл кореспонденция съхраняваме съдържанието на изпратеното запитване и технически данни, необходими за проследяване и обслужване на заявката.',
                    ],
                ],
                [
            ...
            'seo' => [
                ...
                'description' => "Политика за поверителност на {$site['brand']} за онлайн заявки, имейл и телефонни запитвания.",
            ],
        ]));
    }
    ...
    public function terms()
    {
        ...
        return view('pages.legal', array_merge(SiteData::staticPageSummary(), [
            ...
            'sections' => [
                ...
                [
                    'title' => 'Контактни канали',
                    'body' => [
                        'Сайтът поддържа контакт по телефон, имейл и онлайн форма за сервизни заявки. Данните от формата се записват в системата и се изпращат към сервизния екип за последваща обработка.',
                    ],
                ],
            ],
            'seo' => [
